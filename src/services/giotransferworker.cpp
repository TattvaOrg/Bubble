...
// Turn on with QT_LOGGING_RULES="bubble.transfer.debug=true" to trace every
// item. Warnings/errors go out unconditionally under bubble.transfer so the
// user sees failure reasons in the terminal.
Q_LOGGING_CATEGORY(lcTransfer, "bubble.transfer")
